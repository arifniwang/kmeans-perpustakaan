	<link rel="stylesheet" href="../layout/js/bootstrap.min.css">
		...
		<tbody>
			...
			-->	
				...
				while ($r = mysql_fetch_array($query)){
					echo "<TR>
							<TD width='250px'><left><a data-toggle='modal' data-target='#myModal".$r['id_objek']."'>".$r['nama_objek']."</a></left> <input size='35' type='hidden' value='$r[nama_objek]' name='namaobjek'></TD>
				...
				<?php
					$query2 = mysql_query("SELECT * FROM objek ORDER BY id_objek DESC");
					while ($t = mysql_fetch_array($query2)){
					echo'
					
					  <div class="modal fade" id="myModal'.$t['id_objek'].'" role="dialog">
					    <div class="modal-dialog">
					      ...
					      <div class="modal-content">
					        <div class="modal-header">
					          ...
					          <h4 class="modal-title">Buku Yang Di pinjam</h4>
					        </div>
