...
INSERT INTO `hasil` (`id`, `object`, `data1`, `data2`, `data3`, `data4`, `data5`, `data6`, `cluster1`, `cluster2`, `cluster3`)
VALUES
	(1,'M001',2,3,2,0,1,1,'No','Yes','Yes'),
	(2,'M002',2,2,1,0,1,0,'No','Yes','No'),
	(3,'M003',1,2,2,2,0,0,'Yes','No','No'),
	(4,'M004',2,2,2,2,0,0,'Yes','No','No'),
	(5,'M005',1,3,2,2,0,0,'Yes','No','No'),
	(6,'M006',2,2,2,0,1,1,'No','Yes','Yes');
